  ...
  {\hrule \vspace{.2cm} {\sfbold Programmieren mit statistischer Software}\hfill
    ...
    \begin{itemize}
      ...
      \item Machen Sie unbedingt durch Kommentare deutlich, welcher Programm-Code zu welcher (Teil-) Aufgabe gehört.
            Es werden NUR Lösungen korrigiert die im korrekten File liegen korrigiert. Beispiel: Aufgabe1 in Exercise1.R etc.
      ...
      \item Beachten sie die Datei README.md in ihrem Repository, für weitere Informationen.
